...
/**
 * Wrapper around a java.util.List, only here to simulate the "List" of the W3C Algorithm -
...
public class List<E> {
    ...
    /**
     * <b>W3C says:</b> Returns the head of the list
     */
    public E head() {
    ...
    /**
     * Extension to support conversion to ordered sets.<p>
     * Returns a new OrderedSet with
     * copies of the elements in this list .
     * <p>
